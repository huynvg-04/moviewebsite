...
class UserController extends Controller
{
    ...
    public function loginuser(Request $request)
    {
        ...
        if (Auth::attempt($arr, true)) {
            ...
            $request->session()->put('username_12c4movies', $user->username);
            return redirect()->back()->with(['thongbao_level' => 'success', 'thongbao' => "<b>Đăng nhập thành công!</b><br>Hãy tận hưởng những phút giây thư giãn trên <b>12C4Movies</b>"]);
        } else
    ...
    {
        session()->forget('username_12c4movies');
        Auth::logout();
