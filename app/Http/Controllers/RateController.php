...
class RateController extends Controller
{
    public function postRate(Request $request, $movie_id, $user_id)
    {
        ...
        if ($rate->isEmpty()) {
            ...
            $rate->save();
            return redirect()->route('user.movie', $movie_id)->with(['thongbao_level' => 'success', 'thongbao' => '<b>Đánh giá thành công!</b> Cảm ơn bạn.<br>Chúc bạn có những phút giây thư giãn trên <b>12C4Movies</b>']);
        } else {
