@extends('user.master')
@section('title','Tủ Phim Của Tôi - 12C4Movies')
@section('content')
                ...
                <div class="container">
                    <div class="browse-inner">
                        ...
                        <div class="col-md-2 w3l-movie-gride-agile">
                            ...
                            <div>
                            <a title="Xoá khỏi tủ phim" href="{{ route('user.deleteCabinet',[session('username_12c4movies'),$item->id]) }}" class="btn btn-danger btn-block" style="color:#FFFFFF">Xoá</a>
                            </div>
                        </div>
                        @endforeach
                        @endif
