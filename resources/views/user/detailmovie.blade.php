@extends('user.master')
@section('title','Phim '.$movie->vie_name.' ('.$movie->eng_name.') - 12C4Movies')
@section('content')
<!----------------- Movie list begin -------------------->
<div class="faq">
    <div class="container">
                ...
                <div class="moviedetailinfor">
                    ...
                    <div class="row moviebutton">
                        <div class="col-md-6">
                            ...
                            {{-- đã đăng nhập --}}
                            <a href="{{ route('user.addCabinet',[session('username_12c4movies'),$movie->id]) }}" class="btn btn-warning btn-lg btn-block warningbtn">Thêm phim<br>vào
                                tủ</a>
                            @else
                            {{-- chua dang nhap --}}
