...
<div class="header">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                @if (session('username_12c4movies'))
                <div>
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu pull-center">
                                <li class="loggedin"><a href="{{ route('user.getCabinet') }}"><i class="fad fa-film-alt"
                                            style="margin-right:14px; --fa-primary-color: white; --fa-secondary-color: dodgerblue; --fa-secondary-opacity: 1.0;"></i>Tủ
                                        phim</a>
                                </li>
                                <li class="loggedin"><a href="{{ route('user.boughtMovie') }}"><i
                                            class="fad fa-shopping-basket"
                                            style="margin-right:12px; --fa-primary-color: peru; --fa-secondary-color: white; --fa-secondary-opacity: 1.0;"></i>Phim
                                        đã mua</a>
                                </li>
                                <li class="loggedin"><a href="{{ route('user.getWallet') }}"><i class="fad fa-wallet"
                                            style="margin-right:15px; --fa-primary-color: gold; --fa-secondary-color: white; --fa-secondary-opacity: 1.0;"></i>Ví</a>
                                </li>
                                <li class="loggedin"><a href="{{ route('user.getProfile') }}"><i
                                            class="fad fa-user-edit"
                                            style="margin-right:10px; --fa-primary-color: limegreen; --fa-secondary-color: white; --fa-secondary-opacity: 1.0;"></i>Hồ
                                        sơ</a></li>
                                <li class="loggedin"><a href="{{ route('user.historyPayment') }}"><i
                                            class="fad fa-history"
                                            style="margin-right:14px; --fa-primary-color: deeppink; --fa-secondary-color: white; --fa-secondary-opacity: 1.0;"></i>Lịch
                                        sử giao dịch</a></li>
                                <li class="divider"></li>
                                <li class="loggedin"><a href="{{ route('user.logout') }}"><i class="fad fa-sign-out-alt"
                                            style="margin-right:14px; --fa-primary-color: crimson; --fa-secondary-color: white; --fa-secondary-opacity: 1.0;"></i>Đăng
                                        xuất</a>
                                </li>
                            </ul>
                        </li>
